...
| 1.1 (anotação) | 14/08/2026 | Engenheiro | Ciclo CAP-13: VIS-009 / REQ-085 / ARQ-033 **homologados**; IMP não aberta | Despacho de homologação da spec | Sem nova versão de mapa |
| 1.1 (anotação) | 14/08/2026 | Engenheiro | IMP-072 aberta — núcleo persistente MEP-CEO; CAP-13 não homologada | Despacho CTO — abrir IMP da CAP-13 | Sem nova versão de mapa |
