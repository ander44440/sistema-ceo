...
> **Contrato:** VIS-009 / REQ-085 **v1.1 homologados** (16/08/2026) sobre o mínimo **v1.0**; ARQ-033 **v1.1** · **v1.2 homologadas** (16/08/2026).  
...
| ARQ emenda | [`ARQ-033 v1.2`](../architecture/ARQ-033-fronteira-mep-ceo-v1.2.md) | **v1.2 Homologada** — transporte runtime |
